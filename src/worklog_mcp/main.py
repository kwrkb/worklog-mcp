...
class LogEntry(BaseModel):
    ...
    category: str = Field(..., description="ログの分類 (例: 開発, 調査, 薬局業務)")
...
def print_schema():
    ...
    add_log_params_schema = {
        ...
        "properties": {
            ...
            "category": {
                "type": "string",
                "description": "作業の分類。例: '開発', '調査', '薬歴管理'。",
                "default": "General"
            },
            "tags": {
                "type": "array",
    ...
    schema_output = {
        "name": APP_NAME,
        "description": "薬剤師としての業務や開発作業の履歴を正確に記録・検索するためのツールです。日報作成や過去の解決策の検索に役立ちます。",
        "functions": [
            {
                "name": "add_log",
